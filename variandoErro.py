    ...
    while ativo == 0:
        ...
        if menu == 1:
            ...
            if subMenu == 3:
                ...
                print '\n\nGauss Jacobi\n'
                r, k=jacobi(matriz,x, erroMax, iterMax)
                print '\nResposta Final', (r)
                print 'iteracoes: ', (k)
            ...
            if subMenu == 4:
                ...
                print '\n\nGauss Seidel\n'
                r, k =seidel(matriz,x, erroMax, iterMax)
                print '\nResposta Final', (r)
                print 'iteracoes: ', (k)
        ...
        if menu == 2:
            ...
            if subMenu ==2:
                ...
                while flag==0:
                    ...
                    while erroMax<0.00001:

                        print '\n\n------erroMax'
                        
                        erroMax=erroMax*10
                        erroVet.append(erroMax)
                ...
                plt.plot(numIteracoesGJ, erroVet, color='red' , label='Gauss Jacobi')
                plt.plot(numIteracoesGS, erroVet, color='blue' , label='Gauss Seidel')
                plt.xlabel("Iteracoes")
                plt.ylabel("Erros")
                plt.title("Numero de iteracoes x metodo x erro maximo")
                plt.legend()
                plt.show()
